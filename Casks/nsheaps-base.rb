cask 'nsheaps-base' do
  ...
  version '1.0.12' # bump me if you want people to re-install these things, like if the list changed.
  ### WHAT IS THIS
  ...
  def post_install
    ...
    BUNDLE
    (buildpath/"Brewfile.mas").write(bundle)

    system "brew", "bundle", "--file=#{buildpath}/Brewfile.mas"
